export default function getTypography () {
  ...
  const typography = {
    ...
    h2: dsTypo.headingBoldExtralarge,
    h3: dsTypo.headingBoldLarge,
    h4: dsTypo.headingBoldMedium,
    h5: dsTypo.headingBoldSmall,
    h6: dsTypo.headingBoldExtrasmall,
    subtitle1: dsTypo.subheadingSemiboldLarge,
    subtitle2: dsTypo.subheadingSemiboldDefault,
    body1: dsTypo.bodyRegularLarge,
    body2: dsTypo.bodyRegularMedium,
    body3: dsTypo.bodyRegularSmall,
    button: dsTypo.supportBoldTextbutton,
    overline: dsTypo.supportRegularInfo,
    footnote: dsTypo.supportRegularFootnote,
    caption: dsTypo.supportRegularMetadata
  }
